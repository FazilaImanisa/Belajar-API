...
// end-point menambahkan data pelanggran siswa
...
app.get("pelanggaran_siswa/:id_pelanggaran_siswa", (req, res) => {
    let param = {id_pelanggran_siswa: req.params.id_pelanggaran_siswa}
...
app.delete("/pelanggaran_siswa/:id_pelanggaran_siswa", (req, res) => {
    ...
    db.query(sql, param, (error, result) => {
        if (error) {
            ...
            res.json({message: "Data has been deleted bestie purr"})
        }
    })
})
